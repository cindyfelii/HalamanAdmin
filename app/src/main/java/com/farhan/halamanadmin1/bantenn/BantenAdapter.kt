...
class BantenAdapter (
    ...
    val layoutResId: Int,
    val anggotaList: List<variabel_R_banten>
) : ArrayAdapter<variabel_R_banten>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_banten){
        val builder = AlertDialog.Builder(anggotaContext)
        builder.setTitle("Update Data")
        val inflater = LayoutInflater.from(anggotaContext)
        val view = inflater.inflate(R.layout.activity_update_riau, null)
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_banten(anggota.id, nama, alat, bahan, cara )
