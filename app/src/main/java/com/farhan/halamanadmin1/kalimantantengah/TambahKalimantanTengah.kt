...
class TambahKalimantanTengah : AppCompatActivity(){
    ...
    private lateinit var detilList : MutableList<DetilKalimantanTengah>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tambah_detil_kalimantantengah)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (a in snapshot.children){
                        val detil = a.getValue(DetilKalimantanTengah::class.java)
                        if (detil != null){
                            detilList.add(detil)
                        }
                    }

                    val adapter = DetilKalimantanTengahAdapter(this@TambahKalimantanTengah,
    ...
    private fun simpanDetil(){
        ...
        val detil = DetilKalimantanTengah(detilId!!, alat, bahan, cara)
