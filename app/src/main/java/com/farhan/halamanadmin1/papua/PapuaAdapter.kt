...
class PapuaAdapter (
    ...
    val layoutResId: Int,
    val anggotaList: List<variabel_R_papua>
) : ArrayAdapter<variabel_R_papua>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_papua){
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_papua(anggota.id, nama, alat, bahan, cara )
