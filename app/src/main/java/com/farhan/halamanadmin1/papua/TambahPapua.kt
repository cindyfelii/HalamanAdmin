...
class TambahPapua : AppCompatActivity(){
    ...
    private lateinit var detilList : MutableList<DetilPapua>
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (a in snapshot.children){
                        val detil = a.getValue(DetilPapua::class.java)
                        if (detil != null){
                            detilList.add(detil)
                        }
                    }

                    val adapter = DetilPapuaAdapter(this@TambahPapua,
    ...
    private fun simpanDetil(){
        ...
        val detil = DetilPapua(detilId!!, alat, bahan, cara)
