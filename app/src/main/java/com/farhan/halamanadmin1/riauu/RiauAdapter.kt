...
class RiauAdapter (
    ...
    val layoutResId: Int,
    val anggotaList: List<variabel_R_riau>
) : ArrayAdapter<variabel_R_riau>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_riau){
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_riau(anggota.id, nama, alat, bahan, cara )
