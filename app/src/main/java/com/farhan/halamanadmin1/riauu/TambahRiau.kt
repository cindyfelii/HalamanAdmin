...
class TambahRiau : AppCompatActivity(){
    ...
    private lateinit var detilList : MutableList<DetilRiau>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tambah_detil_riau)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    for (a in snapshot.children){
                        val detil = a.getValue(DetilRiau::class.java)
                        if (detil != null){
                            detilList.add(detil)
                        }
                    }

                    val adapter = DetilRiauAdapter(this@TambahRiau,
                        R.layout.activity_item_detil_riau, detilList)
    ...
    private fun simpanDetil(){
        ...
        val detil = DetilRiau(detilId!!, alat, bahan, cara)
