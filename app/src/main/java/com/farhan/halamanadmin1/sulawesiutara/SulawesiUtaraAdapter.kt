...
class SulawesiUtaraAdapter (
    val anggotaContext: Context,
    val layoutResId: Int,
    val anggotaList: List<variabel_R_sulawesiutara>
) : ArrayAdapter<variabel_R_sulawesiutara>(anggotaContext, layoutResId, anggotaList){
    ...
    private fun updateDialog(anggota: variabel_R_sulawesiutara){
        ...
        builder.setPositiveButton("Ubah") {p0, p1 ->
            ...
            val anggota = variabel_R_sulawesiutara(anggota.id, nama, alat, bahan, cara )
